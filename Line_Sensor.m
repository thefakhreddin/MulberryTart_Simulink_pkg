classdef Line_Sensor < matlab.System
...
%         end
        ...
        function [Left, Right] = stepImpl(obj,Feed)
            
            Left=obj.lastDataAnalyzed1/10;
            Right=obj.lastDataAnalyzed2/10;
            ...
            for i=bufferLength-1:-1:1
                if buffer(i)==obj.SectionHeadFlag && buffer(i+1) > 10
                    ...
                    if bufferLength-i-1 >= sectionLength
                        ...
                        if sensorId == hex2dec('02') && sensorPort == obj.Port
