classdef Climate_Sensor < matlab.System
...
%         end
        ...
        function [Temperature, Pressure, Humidity] = stepImpl(obj,Feed)
            
            Temperature=obj.lastDataAnalyzed1/10;
            Pressure=obj.lastDataAnalyzed2/10;
            Humidity=obj.lastDataAnalyzed3/10;
            ...
            for i=bufferLength-1:-1:1
                if buffer(i)==obj.SectionHeadFlag && buffer(i+1) > 10
                    ...
                    if bufferLength-i-1 >= sectionLength
                        ...
                        if sensorId == hex2dec('06') && sensorPort == obj.Port
